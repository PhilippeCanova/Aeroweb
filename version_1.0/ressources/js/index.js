...
function open_track_profil(coord) {
	...
	coupe_trajet_en_cours = new coupe_trajet_Controller(t, "menu2");
	$('#Lance_coupe_trajet').show();
...
{
	var feature = mymap.sourceLine.getFeatures()[0];
	console.log(coupe_trajet_en_cours);
	...
	$.each(coupe_trajet_en_cours.list ,function(i,v){
		...
		if (search) {
			...
			$('#menu2 div div i:eq( '+i+' )').addClass('red-text');
			erreur=true;
			return false;
		}
